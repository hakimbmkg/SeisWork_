...
The if __name__ == "__main__" guard is mandatory: without it, multiprocessing
spawn mode would re-execute this code in every worker process →
recursive spawn → RuntimeError "bootstrapping phase".
"""
import sys
import traceback
