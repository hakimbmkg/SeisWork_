...
Parse heterogeneous catalog/location outputs (REAL, VELEST, hypoDD, GrowClust,
magnitude phase files) into a common per-event frame and summarise RMS / depth /
magnitude / gap, so the GUI Benchmark panel can compare SeisWork results against
reference catalogs side by side.
